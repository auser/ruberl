...
GEM_NAME = 'ruberl' # what ppl will type to install your gem
RUBYFORGE_PROJECT = 'ruberl' # The unix name for your project
...
VERS = Ruberl::VERSION::STRING + (REV ? ".#{REV}" : "")
RDOC_OPTS = ['--quiet', '--title', 'ruberl documentation',
    "--opname", "index.html",
    "--line-numbers",
    "--main", "README",
    "--inline-source"]
